...
std::string build_webp_xmp_packet(const std::string& parameters) {
    ...
    return "<?xpacket begin=\"\" id=\"W5M0MpCehiHzreSzNTczkc9d\"?>\n"
           ...
           "    <rdf:Description xmlns:sdcpp=\"https://github.com/leejet/gguf-diffusion.cpp/ns/1.0/\">\n"
           "      <sdcpp:parameters>" +
           escaped_parameters +
           "</sdcpp:parameters>\n"
           "    </rdf:Description>\n"
...
std::vector<uint8_t> create_webm_from_sd_images_to_vector(sd_image_t* images, int num_images, int fps, int quality, const sd_audio_t* audio) {
    ...
    const int ret = [&]() -> int {
        ...
        segment.GetSegmentInfo()->set_writing_app("gguf-diffusion.cpp");
        segment.GetSegmentInfo()->set_muxing_app("gguf-diffusion.cpp");
