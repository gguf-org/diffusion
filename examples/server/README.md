...
* the server status page is available at `http://127.0.0.1:1234/`
...
The server does not build or embed a web frontend. To serve a custom frontend file at `/`, use:
...
In this case, the server will load and serve the specified `index.html` file. This is useful when:
